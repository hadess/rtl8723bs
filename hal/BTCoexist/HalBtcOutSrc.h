...
typedef struct _BTC_BT_INFO{
	...
	BOOLEAN					bBtPwrSaveMode;	// for 1Ant solution
	BOOLEAN					bForceLps;		// for 1Ant solution
	BOOLEAN					bForceToRoam;	// for 1Ant solution
	u1Byte					forceExecPwrCmdCnt;
	u1Byte					lps1Ant;
	u1Byte					rpwm1Ant;
	u4Byte					raMask;
