...
static u32 usb_bulkout_zero(struct intf_hdl *pintfhdl, u32 addr)
{
	...
	if((padapter->bDriverStopped) || (padapter->bSurpriseRemoved) ||(adapter_to_pwrctl(padapter)->pnp_bstop_trx))
	{
		return _FAIL;
	}
...
_func_enter_;
	...
	if ((padapter->bDriverStopped) || (padapter->bSurpriseRemoved) ||(adapter_to_pwrctl(padapter)->pnp_bstop_trx)) {
		...
		,padapter->bDriverStopped, padapter->bSurpriseRemoved, adapter_to_pwrctl(padapter)->pnp_bstop_trx );
		#endif
